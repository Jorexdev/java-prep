...
public class Ejercicio11 {
    ...
    public static void main(String[] args) {
        ...
        // Ejercicio: producto más caro por categoría
        ...
        products
                ...
                .collect(Collectors.groupingBy(
                        Product::getCategory,
                        Collectors.maxBy(Comparator.comparing(Product::getPrice)) // más caro de cada grupo
                ))
                .values()
                .stream()
                .filter(Optional::isPresent) // descarta categorías vacías
                .map(Optional::get)
